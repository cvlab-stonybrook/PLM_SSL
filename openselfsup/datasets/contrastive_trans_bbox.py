...
class ContrastiveDatasetTransBoxes(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if isinstance(view1, Image.Image):
            ...
            view_1_crop_range_and_flip_box = [
                transf1[0] / h,  # top
                transf1[1] / w,  # left
                transf1[2] / h,  # height
                transf1[3] / w,  # width
            ...
            view_2_crop_range_and_flip_box = [
                transf2[0] / h,
                transf2[1] / w,
                transf2[2] / h,
                transf2[3] / w,
            ...
            boxes1, h_step_1, w_step_1 = gen_bbox(*view_1_crop_range_and_flip_box, self.grid_size)
            boxes2, h_step_2, w_step_2 = gen_bbox(*view_2_crop_range_and_flip_box, self.grid_size)
            ...
            return dict(img=img_cat, transf=[view_1_crop_range_and_flip, view_2_crop_range_and_flip],
                        boxes=boxes)
